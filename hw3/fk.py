...
def your_fk(
    ...
    for i in range(6):
        ...
        # Get the origin of the joint position from the transformation matrix
        joint_origin_position = transformed_link[0:3, 3]

        # Calculate the linear velocity part of the Jacobian column
        jacobian[0:3, i] = np.cross(z_axis, end_effector_position - joint_origin_position)
